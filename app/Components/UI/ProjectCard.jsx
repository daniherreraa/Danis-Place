...
const ProjectCard = (props) => {
  ...
  return (
    <div className="flex flex-col w-full h-max bg-darkless p-4 lg:p-6 xl:p-8 md:p-6 rounded-2xl align-middle">
      <div className="">
        <h2 className="text-darklessText font-medium text-base xl:text-lg md:text-sm lg:text-base">
          {cardTitle}
        </h2>
        <p className="text-lightGray font-normal xl:min-h-[10vh] text-xs xl:text-[1rem] lg:text-xs mt-4 lg:mt-4 xl:mt-4 md:text-xs md:mt-4">
          {cardDescription}
        </p>
      </div>
      <div className="mt-4 md:mt-8 lg:mt-4 xl:mt-8">
        <ul className="flex flex-row justify-end gap-4">
          <li className="flex text-lightPurple text-sm xl:text-base lg:text-xs md:text-xs">
